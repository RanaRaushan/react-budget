...
import { budgetHeaders, dateFields, enumFields, itemCategoryEnum, itemDetailHeaders, lockedFields, paymentTypeEnum, spentTypeEnum } from '../../utils/constantHelper';
...
export default function AddBudgetEntryPage() {
    const [formData, setFormData] = useState(itemDetailHeaders.reduce((acc, col) => {
        acc[col.key] = "";
        return acc;
      }, {}));
