...
import { budgetHeaders, compoundingFrequencyEnum, dateFields, enumFields, investmentHeaders, investmentTypeEnum, itemCategoryEnum, lockedFields, paymentTypeEnum, spentTypeEnum } from '../../utils/constantHelper';
...
export default function AddInvestmentPage() {
    const [formData, setFormData] = useState(investmentHeaders.reduce((acc, col) => {
        acc[col.key] = "";
        return acc;
      }, {}));
                ...
                dateFields.includes(header.key) 
                    ...
                    : enumFields.includes(header.key) 
                        ...
                        >
                            ...
                            {Object.entries(header.key == 'investmentType' ? investmentTypeEnum : compoundingFrequencyEnum).map(([ddKey, ddLabel]) => (
